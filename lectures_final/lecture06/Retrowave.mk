...
WorkspacePath          :=C:/Users/night/Desktop/Retrowave
ProjectPath            :=C:/Users/night/Desktop/Retrowave/lectures_final/lecture06
...
$(IntermediateDirectory)/up_up_include_glad_glad.c$(ObjectSuffix): ../../include/glad/glad.c
	...
	$(CC) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/include/glad/glad.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_up_include_glad_glad.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/imgui.cpp$(ObjectSuffix): imgui.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/imgui.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/imgui.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/imgui_draw.cpp$(ObjectSuffix): imgui_draw.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/imgui_draw.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/imgui_draw.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/imgui_impl_glfw.cpp$(ObjectSuffix): imgui_impl_glfw.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/imgui_impl_glfw.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/imgui_impl_glfw.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ImGuiFileDialog.cpp$(ObjectSuffix): ImGuiFileDialog.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/ImGuiFileDialog.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ImGuiFileDialog.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/imgui_impl_opengl3.cpp$(ObjectSuffix): imgui_impl_opengl3.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/imgui_impl_opengl3.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/imgui_impl_opengl3.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/imgui_demo.cpp$(ObjectSuffix): imgui_demo.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/imgui_demo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/imgui_demo.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Retrowave.cpp$(ObjectSuffix): Retrowave.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/Retrowave.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Retrowave.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/imgui_widgets.cpp$(ObjectSuffix): imgui_widgets.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/night/Desktop/Retrowave/lectures_final/lecture06/imgui_widgets.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/imgui_widgets.cpp$(ObjectSuffix) $(IncludePath)
